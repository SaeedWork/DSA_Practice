public class Int_Linked_List {
    ...
    public void updateAt(int Data, int Position){
        //Error Checking if list empty
        if (this.head == null) {
            System.out.println("List is Empty");
            return;
    ...
    public String searchVal(int Value){
        //Error Checking if list empty
        if (this.head == null) {
        ...
        while (temp != null){
            if (temp.data == Value){
                return "The Value " + Value + " is found on Position : " + pos;
            }else {
                temp = temp.next;
                pos++;
            }
        ...
        return "The Value " + Value + " is not in the List";
